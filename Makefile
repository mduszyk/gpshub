...
Release_target.OBJ = src/hubthread/CoordsBroadcastThread.o src/hubthread/CoordsUpdateThread.o src/hubthread/ServerThread.o src/main.o src/server/CmdPkg.o src/server/CommandHandler.o src/server/CommandServer.o src/server/GpsDataServer.o src/socket/Epoll.o src/socket/EpollException.o src/socket/Socket.o src/socket/SocketException.o src/socket/netutil.o src/thread/ConditionVariable.o src/thread/Mutex.o src/thread/RwLock.o src/thread/ScopeLock.o src/thread/ScopeLockRd.o src/thread/ScopeLockWr.o src/thread/SyncHashMap.o src/thread/SyncHashSet.o src/thread/SyncMap.o src/thread/SyncSet.o src/thread/Thread.o src/thread/ThreadException.o src/thread/ThreadSyncException.o src/user/User.o src/user/UserIdGenerator.o src/util/CircularBuffer.o 
DEP_FILES += src/hubthread/CoordsBroadcastThread.d src/hubthread/CoordsUpdateThread.d src/hubthread/ServerThread.d src/main.d src/server/CmdPkg.d src/server/CommandHandler.d src/server/CommandServer.d src/server/GpsDataServer.d src/socket/Epoll.d src/socket/EpollException.d src/socket/Socket.d src/socket/SocketException.d src/socket/netutil.d src/thread/ConditionVariable.d src/thread/Mutex.d src/thread/RwLock.d src/thread/ScopeLock.d src/thread/ScopeLockRd.d src/thread/ScopeLockWr.d src/thread/SyncHashMap.d src/thread/SyncHashSet.d src/thread/SyncMap.d src/thread/SyncSet.d src/thread/Thread.d src/thread/ThreadException.d src/thread/ThreadSyncException.d src/user/User.d src/user/UserIdGenerator.d src/util/CircularBuffer.d 
